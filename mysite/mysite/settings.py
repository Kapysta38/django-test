...
SECRET_KEY = 'django-insecure-9rc_e4f!_d33qadazyh&lbef#25jn3s%n4d(c4r+frp7@+sy%4'
...
INSTALLED_APPS = [
    'polls.apps.PollsConfig',  # Подключение приложения к проекту
    'django.contrib.admin',  # Адмника сайта
